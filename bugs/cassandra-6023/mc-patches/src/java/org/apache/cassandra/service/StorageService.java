...
public class StorageService extends NotificationBroadcasterSupport implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    public StorageService()
    {
        ...
        MessagingService.instance().registerVerbHandlers(MessagingService.Verb.READ_REQUEST_RESPONSE, new ResponseVerbHandler());   // DMCK
        MessagingService.instance().registerVerbHandlers(MessagingService.Verb.PAXOS_PREPARE_RESPONSE, new ResponseVerbHandler());  // DMCK
        MessagingService.instance().registerVerbHandlers(MessagingService.Verb.PAXOS_PROPOSE_RESPONSE, new ResponseVerbHandler());  // DMCK
        MessagingService.instance().registerVerbHandlers(MessagingService.Verb.PAXOS_COMMIT_RESPONSE, new ResponseVerbHandler());  // DMCK
