...
public class StorageProxy implements StorageProxyMBean
{
    ...
    throws UnavailableException, IsBootstrappingException, ReadTimeoutException, WriteTimeoutException, InvalidRequestException
    {
        ...
        InterceptionLayer.waitForExecuteCas(sourceId);
        ...
        while (System.nanoTime() - start < timeout)
        {
            ...
            logger.info("[DMCK] Reading existing values for CAS precondition");
            ...
            {
                logger.info("[DMCK] CAS precondition {} does not match current values {}", expected, current);
            ...
            logger.info("[DMCK] CAS precondition is met; proposing client-requested updates for {}", ballot);
            ...
            if (proposePaxos(proposal, liveEndpoints, requiredParticipants))
            {
                ...
                // DMCK
                InterceptionLayer.updateWorkloadAccomplishment(sourceId+1, true);
                return null;
            }
    ...
    throws WriteTimeoutException
    {
        ...
        while (System.nanoTime() - start < timeout)
        {
            ...
            if (!summary.promised)
            {
                logger.info("[DMCK] Some replicas have already promised a higher ballot than ours; aborting");
