...
{
    private static final Logger logger = LoggerFactory.getLogger(UUIDGen.class); // DMCK
    ...
    // DMCK
    private static long readCurrentTime() {
        long currentTime = 0;
        try {
